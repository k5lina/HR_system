...
export const departments: Department[] = [
  ...
  { department_id: 2, name: 'Финансовый отдел' },
  { department_id: 3, name: 'Отдел МТС' },
  { department_id: 4, name: 'Складское хозяйство' },
  { department_id: 5, name: 'ИВЦ' },
  { department_id: 6, name: 'Отдел кадров' },
  { department_id: 7, name: 'Сбыт продукции' },
  { department_id: 8, name: 'Технологический отдел' },
  { department_id: 9, name: 'Технический отдел' },
  { department_id: 10, name: 'Отдел маркетинга' },
  { department_id: 11, name: 'Хлебобулочный цех' },
  { department_id: 12, name: 'Салатный цех' },
  { department_id: 13, name: 'Кондитерский цех' },
];
...
export const positions: Position[] = [
  ...
  { position_id: 5, name: 'Нач. отдела МТС', personnel_type_id: 2 },
  ...
  { position_id: 9, name: 'Директор ИВЦ', personnel_type_id: 2 },
  ...
  { position_id: 12, name: 'Специалист по безопасности', personnel_type_id: 2 },
  { position_id: 13, name: 'Директор по кадрам', personnel_type_id: 2 },
  ...
  { position_id: 16, name: 'Нач. отдела по сбыту продукции', personnel_type_id: 2 },
  ...
  { position_id: 22, name: 'Нач. отдела маркетинга', personnel_type_id: 2 },
...
export const departmentPositions: DepartmentPosition[] = [
  ...
  { department_position_id: 6, department_id: 4, position_id: 7 },
  { department_position_id: 7, department_id: 4, position_id: 8 },
  { department_position_id: 8, department_id: 5, position_id: 9 },
  { department_position_id: 9, department_id: 5, position_id: 10 },
  { department_position_id: 10, department_id: 5, position_id: 11 },
  { department_position_id: 11, department_id: 5, position_id: 12 },
  { department_position_id: 12, department_id: 6, position_id: 13 },
  { department_position_id: 13, department_id: 6, position_id: 14 },
  { department_position_id: 14, department_id: 6, position_id: 15 },
  { department_position_id: 15, department_id: 7, position_id: 16 },
  { department_position_id: 16, department_id: 7, position_id: 17 },
  { department_position_id: 17, department_id: 8, position_id: 18 },
  { department_position_id: 18, department_id: 8, position_id: 19 },
  { department_position_id: 19, department_id: 9, position_id: 20 },
  { department_position_id: 20, department_id: 9, position_id: 21 },
  { department_position_id: 21, department_id: 10, position_id: 22 },
  { department_position_id: 22, department_id: 10, position_id: 23 },
  { department_position_id: 23, department_id: 11, position_id: 24 },
  { department_position_id: 24, department_id: 11, position_id: 25 },
  { department_position_id: 25, department_id: 12, position_id: 26 },
  { department_position_id: 26, department_id: 12, position_id: 27 },
  { department_position_id: 27, department_id: 13, position_id: 28 },
  { department_position_id: 28, department_id: 13, position_id: 29 },
];
